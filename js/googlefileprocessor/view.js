...
zipextractor.View = function (presenter, pickerManager, uploadManager) {
    this.model_ = null;
...
zipextractor.View.APP_NAME_ = 'Google Drive';
...
zipextractor.View.prototype.attachListeners_ = function () {
    ...
    this.uploadToDriveButtonButton.onclick = zipextractor.util.bindFn(this.uploadToDriveButtonButtonClick_, this);
...
zipextractor.View.prototype.updateState = function (newState, oldState, opt_data) {
    ...
    switch (newState) {
        ...
        case zipextractor.state.SessionState.ZIP_READING:
            ...
            this.enableEl_(this.uploadToDriveButtonButton, false);
...
zipextractor.View.prototype.uploadToDriveButtonButtonClick_ = function (e) {
    this.uploadManager_.show(
        zipextractor.util.UploadManager.UploadMode.FILE,
        zipextractor.util.bindFn(this.handlePickerFileSelected_, this));
};
